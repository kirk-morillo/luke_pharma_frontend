<template>
    <div class="min-h-screen flex flex-col font-sans bg-gray-50">
        ...
        <main class="flex-grow">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 lg:py-16">
                
                <section id="hero" class="flex flex-col items-center justify-center text-center 
                                bg-gradient-to-br from-white to-red-50/70 
                                rounded-3xl shadow-xl p-12 lg:p-20 relative overflow-hidden">
                    <div class="hero-text-content max-w-3xl">
                        ...
                        <router-link to="/products"
                            class="inline-flex items-center justify-center gap-3 
                                     ...
                                     px-8 py-4 
                                     rounded-full text-xl font-bold uppercase tracking-wider
                                     shadow-lg shadow-red-100/50 transition-all duration-300 transform hover:scale-105">
                ...
                <section id="frequently-sold"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                        <ProductCard v-for="product in frequentlySoldProducts" :key="product.id" :product="product"
                ...
                <section id="branches" class="bg-white rounded-3xl p-6 sm:p-8 lg:p-12 shadow-2xl">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
                        <div v-for="branch in mockBranches.slice(0, 3)" :key="branch.id" class="branch-card 
                                    text-center bg-white 
                                    rounded-xl shadow-lg hover:shadow-2xl p-8 
                                    transition-all duration-300 transform hover:-translate-y-1 
                                    w-full max-w-sm border-2 border-transparent hover:border-red-400">
